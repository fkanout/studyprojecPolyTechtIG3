...
<ul id="css3menu0" class="topmenu">
	...
	<li class="topmenu"><a style="width:100px;height:27px;line-height:27px;"><img src="admin_files/css3menu0/plus3.png" alt=""/>Ajouter</a>
<ul>
...
<form name="form1"  method="post" action="ajoute_rames.php" >
		  
<p>ID Rames<input name="IDRAMES" type="text" required="required" placeholder="Identificatuer de la RAM" />
Modele:  
  <input name="Modele"  type="text" required="required" placeholder="Model de RAM"  />
  <br />
  Date de circulation:
<input name="Datecirculation" type="text" required="required" placeholder="DD-MM-YYYY" ><br>
 </p>
</p>
<p>Etat:<br>
<select name="etat">
  ...
  <option value="EN FORAMTION">EN FORMATION</option>
</select>
<br>
------------------------
<input name="ADD" type="submit"  value="Ajouter"/><br />
