...
<form name="form1"  method="post" action="ajoute_voyages.php" >
		  
<p>ID voyage<input name="IDVOYAGES" type="text" required="required" placeholder="Numbre" /><br>
<p>ID de rame:<input name="rameid"  type="text" required="required" placeholder="Numbre" /><br />
<p>ID de conducteurs:<input name="cond" type="text" required="required" placeholder="Numbre" /> 
<br>
...
<p>KM de voyage:
  <input name="KM" type="text" required="required" placeholder="Combien de KM">
  <br />
 <p> Date de voyage:<input type="text" name="DureeTotal" placeholder="DD-MM-YYYY" ><br>

------------------------ <br />
<input name="Submit" type="submit"  value="Ajouter"/> <br />
<?php if (!empty($_GET["s"])) { $s=$_GET['s']; echo "<font color='red'> $s  </font>"; }?>
</form>
</div>
...
<?php echo "Administrateur en ligne : <font color='red'>$nameofsession</font>"; ?>
