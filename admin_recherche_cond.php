...
<form name="form1"  method="post" action="recherche_cond.php" target="_blank" >
		  
<p>Champs de recherche<input name="IDRECH" type="text" required="required" placeholder="Si choix TOUS, tapez *" />
<p>Rechercher Par:
  <br />
  <select name="range">
